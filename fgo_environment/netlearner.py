...
>>>>>>> Stashed changes
        ...
        model.add(Dense(128, init='glorot_normal', activation = 'relu', input_dim=self.len_feature_vec))
...
<<<<<<< Updated upstream
        model = load_model('D:/projects/multiagent_pendragon_dev_2/fgo_environment/models/run2_good_run/new_chaldea_card_model_12_7_19_iteration_40000.h5')
=======
        model = load_model('D:/projects/multiagent_pendragon_dev_2/fgo_environment/models/card_model_trainingnew/new_chaldea_card_model_12_7_19_iteration_420000.h5')
>>>>>>> Stashed changes
    ...
    def get_action(self, state):
        ...
        game_state_array = np.reshape(np.asarray(state), (1, self.len_feature_vec))

        rewards = self._model.predict(game_state_array, batch_size=1)
        ...
        self._last_state = game_state_array#convert_card_list(state)
